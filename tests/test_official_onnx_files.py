...
MODEL_EXTRA_VERIFY_ARGS = {
    ...
    **{
        ...
        for d in (
            "Int8_run0", "Int8_run1", "Int8_run2", "Int8_run3",
            "Int8_run4", "Int8_run5", "Int8_run6", "Int8_run7",
            "Int8_run8", "Int8_run9", "Int8_run10", "Int8_run11",
            "Int8_run12", "Int8_run13", "Int8_run14", "Int8_run15",
            "UInt8_run0", "UInt8_run1", "UInt8_run2", "UInt8_run3",
            "UInt8_run4", "UInt8_run5", "UInt8_run6", "UInt8_run7",
            "UInt8_run8", "UInt8_run9", "UInt8_run10", "UInt8_run11",
            "UInt8_run12", "UInt8_run13", "UInt8_run14", "UInt8_run15",
            "WithConstantBInputs_run0", "WithConstantBInputs_run1",
            "WithConstantBInputs_run2", "WithConstantBInputs_run3",
            "WithConstantBInputs_run4", "WithConstantBInputs_run5",
        )
    },
}
