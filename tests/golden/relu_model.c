 ...
 * Model checksum (sha256): f64a5b7d9cf635f64bf2fee6e7df6125e7523eba08c72ef68a56bec474f1971e
 * Model name: model
 ...
 * Attrs: n/a
 */
EMX_NODE_FN void node0_relu(const float input0[2][3], float output[2][3]) {
