 ...
 * Model checksum (sha256): d19ee9aea204ee35f6b5ca51faed3d29c6389e076582f4b055db789490daa385
 * Model name: model
 ...
 * Attrs: n/a
 */
EMX_NODE_FN void node2_relu(const float input0[2][3], float output[2][3]) {
    for (idx_t i0 = 0; i0 < 2; ++i0) {
        for (idx_t i1 = 0; i1 < 3; ++i1) {
