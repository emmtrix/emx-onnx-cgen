 ...
 * Attrs: n/a
 */
static inline void node0_identity(const emx_string_t input0[2], emx_string_t output[2]) {
    for (idx_t i0 = 0; i0 < 2; ++i0) {
        for (idx_t str_idx = 0; str_idx < EMX_STRING_MAX; ++str_idx) {
            output[i0][str_idx] = input0[i0][str_idx];
        }
    }
}
...
void identity_string_model(const emx_string_t x[restrict 2], emx_string_t out[restrict 2]) {
