 ...
 * Model checksum (sha256): 4a785c9a7786b758b72d961b4119a071f9d3faa49770a472895965fddccb7cb4
 * Model name: model
 * Graph name: optional_get_element_tensor_graph
...
void model(const float tensor_input[restrict 4], float output[restrict 4]) {
    node0_optionalgetelement(tensor_input, output);
}
