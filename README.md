...
It now targets **full standard ONNX opset 26 support** based on **ONNX v1.21.0** and supports **nearly all microsoft ONNX operators** based on **ONNX Runtime 1.24.4**.
