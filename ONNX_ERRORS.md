...
| --- | --- | --- |
| Failed to build testbench (cc: error: unrecognized command-line option ‘-std=c23’; did you mean ‘-std=c2x’?). | 60 | 25 |
...
| DequantizeLinear supports int8/uint8/int16/uint16/int32/uint32 inputs only | 4 | 25 |
| QuantizeLinear supports int8/uint8/int16/uint16 outputs only | 4 | 25 |
...
| Failed to build testbench (cc: error: unrecognized command-line option ‘-std=c23’; did you mean ‘-std=c2x’?). | 25 | 60 |
...
| DequantizeLinear supports int8/uint8/int16/uint16/int32/uint32 inputs only | 25 | 4 |
| QuantizeLinear supports int8/uint8/int16/uint16 outputs only | 25 | 4 |
