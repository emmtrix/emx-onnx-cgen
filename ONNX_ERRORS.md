...
| Failed to build testbench (model.c:132:21: error: pointer value used where a floating-point was expected). | 41 |  |
| Failed to build testbench (model.c:121:21: error: pointer value used where a floating-point was expected). | 30 |  |
| Failed to build testbench (model.c:5870:21: error: pointer value used where a floating-point was expected). | 26 |  |
| Failed to build testbench (model.c:1838:21: error: pointer value used where a floating-point was expected). | 22 |  |
| Failed to build testbench (model.c:131:17: error: pointer value used where a floating-point was expected). | 20 |  |
| Failed to build testbench (model.c:5294:21: error: pointer value used where a floating-point was expected). | 18 |  |
| Failed to build testbench (model.c:686:21: error: pointer value used where a floating-point was expected). | 18 |  |
| Failed to build testbench (model.c:107:21: error: pointer value used where a floating-point was expected). | 17 |  |
| Failed to build testbench (model.c:3278:21: error: pointer value used where a floating-point was expected). | 16 |  |
| Failed to build testbench (model.c:462:21: error: pointer value used where a floating-point was expected). | 16 |  |
| Failed to build testbench (model.c:558:21: error: pointer value used where a floating-point was expected). | 16 |  |
| Failed to build testbench (model.c:120:21: error: pointer value used where a floating-point was expected). | 15 |  |
| Failed to build testbench (model.c:114:17: error: pointer value used where a floating-point was expected). | 14 |  |
| Failed to build testbench (model.c:126:17: error: pointer value used where a floating-point was expected). | 14 |  |
| Failed to build testbench (model.c:143:17: error: pointer value used where a floating-point was expected). | 14 |  |
| Failed to build testbench (model.c:115:21: error: pointer value used where a floating-point was expected). | 13 |  |
| Failed to build testbench (model.c:128:21: error: pointer value used where a floating-point was expected). | 13 |  |
| Failed to build testbench (model.c:140:21: error: pointer value used where a floating-point was expected). | 13 |  |
| Failed to build testbench (model.c:963:21: error: pointer value used where a floating-point was expected). | 13 |  |
| Failed to build testbench (model.c:3555:21: error: pointer value used where a floating-point was expected). | 12 |  |
| Failed to build testbench (model.c:3722:21: error: pointer value used where a floating-point was expected). | 12 |  |
| Failed to build testbench (model.c:3769:21: error: pointer value used where a floating-point was expected). | 12 |  |
| Failed to build testbench (model.c:450:17: error: pointer value used where a floating-point was expected). | 12 |  |
| Failed to build testbench (model.c:465:17: error: pointer value used where a floating-point was expected). | 12 |  |
...
| Failed to build testbench (model.c:4419:21: error: pointer value used where a floating-point was expected). | 9 |  |
| Failed to build testbench (model.c:4446:21: error: pointer value used where a floating-point was expected). | 9 |  |
| Failed to build testbench (model.c:4493:21: error: pointer value used where a floating-point was expected). | 9 |  |
| Failed to build testbench (model.c:579:21: error: pointer value used where a floating-point was expected). | 9 |  |
| Failed to build testbench (model.c:606:21: error: pointer value used where a floating-point was expected). | 9 |  |
| Failed to build testbench (model.c:621:21: error: pointer value used where a floating-point was expected). | 9 |  |
| Failed to build testbench (model.c:106:17: error: pointer value used where a floating-point was expected). | 8 |  |
| Failed to build testbench (model.c:118:17: error: pointer value used where a floating-point was expected). | 8 |  |
| Failed to build testbench (model.c:120:17: error: pointer value used where a floating-point was expected). | 8 |  |
| Failed to build testbench (model.c:132:17: error: pointer value used where a floating-point was expected). | 8 |  |
| Failed to build testbench (model.c:2403:21: error: pointer value used where a floating-point was expected). | 8 |  |
| Failed to build testbench (model.c:2416:21: error: pointer value used where a floating-point was expected). | 8 |  |
| Failed to build testbench (model.c:2463:21: error: pointer value used where a floating-point was expected). | 8 |  |
| Failed to build testbench (model.c:2979:21: error: pointer value used where a floating-point was expected). | 8 |  |
| Failed to build testbench (model.c:3118:21: error: pointer value used where a floating-point was expected). | 8 |  |
| Failed to build testbench (model.c:3165:21: error: pointer value used where a floating-point was expected). | 8 |  |
| Failed to build testbench (model.c:355:21: error: pointer value used where a floating-point was expected). | 8 |  |
| Failed to build testbench (model.c:368:21: error: pointer value used where a floating-point was expected). | 8 |  |
| Failed to build testbench (model.c:383:21: error: pointer value used where a floating-point was expected). | 8 |  |
| Failed to build testbench (model.c:451:21: error: pointer value used where a floating-point was expected). | 8 |  |
| Failed to build testbench (model.c:466:21: error: pointer value used where a floating-point was expected). | 8 |  |
| Failed to build testbench (model.c:4718:21: error: pointer value used where a floating-point was expected). | 8 |  |
| Failed to build testbench (model.c:481:21: error: pointer value used where a floating-point was expected). | 8 |  |
| Failed to build testbench (model.c:6720:17: error: pointer value used where a floating-point was expected). | 8 |  |
| Failed to build testbench (model.c:6767:17: error: pointer value used where a floating-point was expected). | 8 |  |
| Failed to build testbench (model.c:7595:17: error: pointer value used where a floating-point was expected). | 8 |  |
| Failed to build testbench (model.c:7642:17: error: pointer value used where a floating-point was expected). | 8 |  |
...
| Failed to build testbench (model.c:1007:17: error: pointer value used where a floating-point was expected). | 6 |  |
| Failed to build testbench (model.c:105:17: error: pointer value used where a floating-point was expected). | 6 |  |
| Failed to build testbench (model.c:117:17: error: pointer value used where a floating-point was expected). | 6 |  |
| Failed to build testbench (model.c:119:17: error: pointer value used where a floating-point was expected). | 6 |  |
| Failed to build testbench (model.c:1835:17: error: pointer value used where a floating-point was expected). | 6 |  |
| Failed to build testbench (model.c:1882:17: error: pointer value used where a floating-point was expected). | 6 |  |
| Failed to build testbench (model.c:2402:17: error: pointer value used where a floating-point was expected). | 6 |  |
| Failed to build testbench (model.c:2449:17: error: pointer value used where a floating-point was expected). | 6 |  |
| Failed to build testbench (model.c:3277:17: error: pointer value used where a floating-point was expected). | 6 |  |
| Failed to build testbench (model.c:3324:17: error: pointer value used where a floating-point was expected). | 6 |  |
| Failed to build testbench (model.c:354:17: error: pointer value used where a floating-point was expected). | 6 |  |
| Failed to build testbench (model.c:3565:21: error: pointer value used where a floating-point was expected). | 6 |  |
| Failed to build testbench (model.c:369:17: error: pointer value used where a floating-point was expected). | 6 |  |
| Failed to build testbench (model.c:461:17: error: pointer value used where a floating-point was expected). | 6 |  |
| Failed to build testbench (model.c:476:17: error: pointer value used where a floating-point was expected). | 6 |  |
...
| Failed to build testbench (model.c:137:31: error: passing argument 3 of ‘node0_node1’ from incompatible pointer type [-Wincompatible-pointer-types]). | 4 |  |
| Failed to build testbench (model.c:148:17: error: pointer value used where a floating-point was expected). | 4 |  |
| Failed to build testbench (model.c:160:17: error: pointer value used where a floating-point was expected). | 4 |  |
| Failed to build testbench (model.c:171:17: error: pointer value used where a floating-point was expected). | 4 |  |
| Failed to build testbench (model.c:183:17: error: pointer value used where a floating-point was expected). | 4 |  |
| Failed to build testbench (model.c:2688:17: error: pointer value used where a floating-point was expected). | 4 |  |
| Failed to build testbench (model.c:2735:17: error: pointer value used where a floating-point was expected). | 4 |  |
| Failed to build testbench (model.c:2976:17: error: pointer value used where a floating-point was expected). | 4 |  |
| Failed to build testbench (model.c:2989:21: error: pointer value used where a floating-point was expected). | 4 |  |
| Failed to build testbench (model.c:3023:17: error: pointer value used where a floating-point was expected). | 4 |  |
| Failed to build testbench (model.c:3552:17: error: pointer value used where a floating-point was expected). | 4 |  |
| Failed to build testbench (model.c:3562:17: error: pointer value used where a floating-point was expected). | 4 |  |
| Failed to build testbench (model.c:3563:17: error: pointer value used where a floating-point was expected). | 4 |  |
| Failed to build testbench (model.c:3599:17: error: pointer value used where a floating-point was expected). | 4 |  |
| Failed to build testbench (model.c:3609:17: error: pointer value used where a floating-point was expected). | 4 |  |
| Failed to build testbench (model.c:3610:17: error: pointer value used where a floating-point was expected). | 4 |  |
| Failed to build testbench (model.c:384:17: error: pointer value used where a floating-point was expected). | 4 |  |
| Failed to build testbench (model.c:399:17: error: pointer value used where a floating-point was expected). | 4 |  |
| Failed to build testbench (model.c:4203:17: error: pointer value used where a floating-point was expected). | 4 |  |
| Failed to build testbench (model.c:4696:17: error: pointer value used where a floating-point was expected). | 4 |  |
| Failed to build testbench (model.c:4712:17: error: pointer value used where a floating-point was expected). | 4 |  |
| Failed to build testbench (model.c:4907:17: error: pointer value used where a floating-point was expected). | 4 |  |
| Failed to build testbench (model.c:491:17: error: pointer value used where a floating-point was expected). | 4 |  |
| Failed to build testbench (model.c:4923:17: error: pointer value used where a floating-point was expected). | 4 |  |
| Failed to build testbench (model.c:506:17: error: pointer value used where a floating-point was expected). | 4 |  |
| Failed to build testbench (model.c:5867:17: error: pointer value used where a floating-point was expected). | 4 |  |
| Failed to build testbench (model.c:5914:17: error: pointer value used where a floating-point was expected). | 4 |  |
| Failed to build testbench (model.c:7598:21: error: pointer value used where a floating-point was expected). | 4 |  |
| Failed to build testbench (model.c:832:17: error: pointer value used where a floating-point was expected). | 4 |  |
| Failed to build testbench (model.c:847:17: error: pointer value used where a floating-point was expected). | 4 |  |
| Failed to build testbench (model.c:939:17: error: pointer value used where a floating-point was expected). | 4 |  |
| Failed to build testbench (model.c:954:17: error: pointer value used where a floating-point was expected). | 4 |  |
...
| Failed to build testbench (model.c:2274:17: error: pointer value used where a floating-point was expected). | 3 |  |
...
| Failed to build testbench (model.c:11051:17: error: pointer value used where a floating-point was expected). | 2 |  |
| Failed to build testbench (model.c:11098:17: error: pointer value used where a floating-point was expected). | 2 |  |
...
| Failed to build testbench (model.c:138:31: error: passing argument 3 of ‘node0_node1’ from incompatible pointer type [-Wincompatible-pointer-types]). | 2 |  |
| Failed to build testbench (model.c:151:31: error: passing argument 3 of ‘node0_node1’ from incompatible pointer type [-Wincompatible-pointer-types]). | 2 |  |
| Failed to build testbench (model.c:192:17: error: pointer value used where a floating-point was expected). | 2 |  |
| Failed to build testbench (model.c:1955:21: error: pointer value used where a floating-point was expected). | 2 |  |
| Failed to build testbench (model.c:2669:17: error: pointer value used where a floating-point was expected). | 2 |  |
| Failed to build testbench (model.c:3182:21: error: pointer value used where a floating-point was expected). | 2 |  |
| Failed to build testbench (model.c:3424:17: error: pointer value used where a floating-point was expected). | 2 |  |
| Failed to build testbench (model.c:3467:17: error: pointer value used where a floating-point was expected). | 2 |  |
| Failed to build testbench (model.c:3936:17: error: pointer value used where a floating-point was expected). | 2 |  |
| Failed to build testbench (model.c:3955:17: error: pointer value used where a floating-point was expected). | 2 |  |
| Failed to build testbench (model.c:4222:17: error: pointer value used where a floating-point was expected). | 2 |  |
| Failed to build testbench (model.c:4246:17: error: pointer value used where a floating-point was expected). | 2 |  |
| Failed to build testbench (model.c:435:21: error: pointer value used where a floating-point was expected). | 2 |  |
| Failed to build testbench (model.c:512:17: error: pointer value used where a floating-point was expected). | 2 |  |
| Failed to build testbench (model.c:527:17: error: pointer value used where a floating-point was expected). | 2 |  |
| Failed to build testbench (model.c:619:17: error: pointer value used where a floating-point was expected). | 2 |  |
| Failed to build testbench (model.c:634:17: error: pointer value used where a floating-point was expected). | 2 |  |
| Failed to build testbench (model.c:6723:21: error: pointer value used where a floating-point was expected). | 2 |  |
| Failed to build testbench (model.c:6758:21: error: pointer value used where a floating-point was expected). | 2 |  |
| Failed to build testbench (model.c:6805:21: error: pointer value used where a floating-point was expected). | 2 |  |
| Failed to build testbench (model.c:746:17: error: pointer value used where a floating-point was expected). | 2 |  |
| Failed to build testbench (model.c:756:17: error: pointer value used where a floating-point was expected). | 2 |  |
| Failed to build testbench (model.c:8301:17: error: pointer value used where a floating-point was expected). | 2 |  |
| Failed to build testbench (model.c:878:21: error: pointer value used where a floating-point was expected). | 2 |  |
| Failed to build testbench (model.c:94:17: error: pointer value used where a floating-point was expected). | 2 |  |
...
| Failed to build testbench (model.c:2841:21: error: pointer value used where a floating-point was expected). | 1 |  |
| Failed to build testbench (model.c:365:21: error: pointer value used where a floating-point was expected). | 1 |  |
| Failed to build testbench (model.c:3811:21: error: pointer value used where a floating-point was expected). | 1 |  |
| Failed to build testbench (model.c:5474:17: error: pointer value used where a floating-point was expected). | 1 |  |
| Failed to build testbench (model.c:6253:17: error: pointer value used where a floating-point was expected). | 1 |  |
| Failed to build testbench (model.c:675:21: error: pointer value used where a floating-point was expected). | 1 |  |
| Failed to build testbench (model.c:690:21: error: pointer value used where a floating-point was expected). | 1 |  |
| Failed to build testbench (model.c:709:21: error: pointer value used where a floating-point was expected). | 1 |  |
| Failed to build testbench (model.c:7522:17: error: pointer value used where a floating-point was expected). | 1 |  |
| Failed to build testbench (model.c:771:21: error: pointer value used where a floating-point was expected). | 1 |  |
| Failed to build testbench (model.c:97:21: error: pointer value used where a floating-point was expected). | 1 |  |
