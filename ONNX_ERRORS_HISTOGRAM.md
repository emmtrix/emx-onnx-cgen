...
| --- | --- | --- |
| Failed to import model graph: Unsupported elem_type 17 (FLOAT8E4M3FN) for tensor '*'. | 22 | 25 |
| Failed to import model graph: Unsupported elem_type 19 (FLOAT8E5M2) for tensor '*'. | 20 | 25 |
| Failed to import model graph: Unsupported elem_type 18 (FLOAT8E4M3FNUZ) for tensor '*'. | 18 | 25 |
| Failed to import model graph: Unsupported elem_type 20 (FLOAT8E5M2FNUZ) for tensor '*'. | 18 | 25 |
| Failed to import model graph: Unsupported elem_type 21 (UINT4) for tensor '*'. | 17 | 25 |
| Failed to import model graph: Unsupported elem_type 22 (INT4) for tensor '*'. | 17 | 25 |
| Failed to import model graph: Unsupported elem_type 25 (UINT2) for tensor '*'. | 17 | 25 |
| Failed to import model graph: Unsupported elem_type 26 (INT2) for tensor '*'. | 17 | 25 |
| Failed to import model graph: Unsupported elem_type 23 (FLOAT4E2M1) for tensor '*'. | 14 | 25 |
...
| Failed to import model graph: Unsupported elem_type 24 (FLOAT8E8M0) for tensor '*'. | 4 | 25 |
| Failed to import model graph: Unsupported optional element type '*' for '*'. Hint: export the model with optional tensor inputs/outputs. | 4 | 16, 18 |
...
| Failed to import model graph: Dynamic dim for tensor '*' | 1 | 12 |
...
| Failed to import model graph: Dynamic dim for tensor '*' | 12 | 1 |
...
| Failed to import model graph: Unsupported optional element type '*' for '*'. Hint: export the model with optional tensor inputs/outputs. | 16 | 3 |
...
| Failed to import model graph: Unsupported optional element type '*' for '*'. Hint: export the model with optional tensor inputs/outputs. | 18 | 1 |
...
| Failed to import model graph: Unsupported elem_type 17 (FLOAT8E4M3FN) for tensor '*'. | 25 | 22 |
| Failed to import model graph: Unsupported elem_type 19 (FLOAT8E5M2) for tensor '*'. | 25 | 20 |
| Failed to import model graph: Unsupported elem_type 18 (FLOAT8E4M3FNUZ) for tensor '*'. | 25 | 18 |
| Failed to import model graph: Unsupported elem_type 20 (FLOAT8E5M2FNUZ) for tensor '*'. | 25 | 18 |
| Failed to import model graph: Unsupported elem_type 21 (UINT4) for tensor '*'. | 25 | 17 |
| Failed to import model graph: Unsupported elem_type 22 (INT4) for tensor '*'. | 25 | 17 |
| Failed to import model graph: Unsupported elem_type 25 (UINT2) for tensor '*'. | 25 | 17 |
| Failed to import model graph: Unsupported elem_type 26 (INT2) for tensor '*'. | 25 | 17 |
| Failed to import model graph: Unsupported elem_type 23 (FLOAT4E2M1) for tensor '*'. | 25 | 14 |
| Failed to import model graph: Unsupported elem_type 24 (FLOAT8E8M0) for tensor '*'. | 25 | 4 |
