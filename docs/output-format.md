...
general loop-nest patterns described above. Noteworthy algorithmic choices,
implementation details, and limitations are documented per operator in
[`docs/operator-notes.md`](operator-notes.md).
