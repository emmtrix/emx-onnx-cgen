...
_FLOAT8_FROM_F32_NO_SAT_BODY: Dict[str, List[str]] = {
    "emx_float8e4m3fn_t": [
        ...
        "    float a = fabsf(v);",
        "    if (a == 0.0f) return s;",
        "    if (a > 448.0f) return s | 0x7Fu;",
        "    int e; float f = frexpf(a, &e); e--; f *= 2.0f;",
        "    int be = e + 7;",
        "    if (be >= 1) {",
        "        int m = (int)rintf((f - 1.0f) * 8.0f);",
        "        if (m >= 8) { m = 0; be++; }",
        "        if (be > 15 || (be == 15 && m >= 7)) return s | 0x7Fu;",
        "        return s | (uint8_t)((be << 3) | m);",
        "    }",
        "    int m = (int)rintf(ldexpf(a, 9));",
        "    if (m >= 8) return s | (1u << 3);",
    ...
    "emx_float8e4m3fnuz_t": [
        ...
        "    if (a == 0.0f) return 0u;",
        "    uint8_t s = signbit(v) ? 0x80u : 0u;",
        "    if (a > 240.0f) return 0x80u;",
        "    int e; float f = frexpf(a, &e); e--; f *= 2.0f;",
        "    int be = e + 8;",
        "    if (be >= 1) {",
        "        int m = (int)rintf((f - 1.0f) * 8.0f);",
        "        if (m >= 8) { m = 0; be++; }",
        "        if (be > 15) return 0x80u;",
        "        return s | (uint8_t)((be << 3) | m);",
        "    }",
        "    int m = (int)rintf(ldexpf(a, 10));",
        "    if (m >= 8) return s | (1u << 3);",
    ...
    "emx_float8e5m2fnuz_t": [
        ...
        "    if (a == 0.0f) return 0u;",
        "    uint8_t s = signbit(v) ? 0x80u : 0u;",
        "    if (a > 57344.0f) return 0x80u;",
        "    int e; float f = frexpf(a, &e); e--; f *= 2.0f;",
        "    int be = e + 16;",
        "    if (be >= 1) {",
        "        int m = (int)rintf((f - 1.0f) * 4.0f);",
        "        if (m >= 4) { m = 0; be++; }",
        "        if (be > 31) return 0x80u;",
        "        return s | (uint8_t)((be << 2) | m);",
        "    }",
        "    int m = (int)rintf(ldexpf(a, 17));",
        "    if (m >= 4) return s | (1u << 2);",
...
_SCALAR_TYPES: Dict[ScalarType, _ScalarTypeInfo] = {
    ...
    ScalarType.I2: _ScalarTypeInfo(
        scalar_type=ScalarType.I2,
        c_type="_BitInt(2)",
        prefix="ref_scalar_i2_",
        suffix="i2",
        is_float=False,
        is_bool=False,
        is_signed=True,
    ...
    ScalarType.I4: _ScalarTypeInfo(
        scalar_type=ScalarType.I4,
        c_type="_BitInt(4)",
        prefix="ref_scalar_i4_",
        suffix="i4",
        is_float=False,
        is_bool=False,
        is_signed=True,
    ...
    ScalarType.U2: _ScalarTypeInfo(
        scalar_type=ScalarType.U2,
        c_type="unsigned _BitInt(2)",
        prefix="ref_scalar_u2_",
        suffix="u2",
        is_float=False,
        is_bool=False,
        is_signed=False,
    ...
    ScalarType.U4: _ScalarTypeInfo(
        scalar_type=ScalarType.U4,
        c_type="unsigned _BitInt(4)",
        prefix="ref_scalar_u4_",
        suffix="u4",
        is_float=False,
        is_bool=False,
        is_signed=False,
